...
setup(
    name='{{cookiecutter.wireload_package_name}}',
    version={{cookiecutter.wireload_package_name}}.__version__,
    description=long_description,
    author={{cookiecutter.wireload_package_name}}.__author__,
    author_email={{cookiecutter.wireload_package_name}}.__contact__,
    url={{cookiecutter.wireload_package_name}}.__homepage__,
